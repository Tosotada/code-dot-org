...
Then(/^I make a playlab project named "([^"]*)"$/) do |name|
  steps %Q{
    Then I am on "http://studio.code.org/projects/playlab"
...
Then(/^I feature the project$/) do
  steps %Q{
    Then I press "#feature_project" using jQuery
  }
end

Then(/^I unfeature the project$/) do
  steps %Q{
    Then I click selector "#ui-hide-show" once I see it
    Then I click selector "#unfeature_project" once I see it
  }
end
